...
const Edit = ({ section }) => {
    ...
    useEffect(() => {
        try {
            if (data.mapping_config && data.mapping_config.trim()) {
                ...
                if (Array.isArray(parsedFields)) {
                    const groups = normalizeMappingConfig(parsedFields);
  ...
  margin-top: 5px;
    ...
    const generateMappingTemplate = () => {
        ...
        const itemTemplate = fieldsForGroup.map(field =>
            ...
            <div className="card mb-4">
                ...
                <div className="card-body">
                    <div className="d-flex gap-2 flex-wrap">
                        ...
                        {data.mapping_enabled && (mappingGroups[activeMappingGroupIndex]?.fields || []).length > 0 && (
                            <button
                                type="button"
